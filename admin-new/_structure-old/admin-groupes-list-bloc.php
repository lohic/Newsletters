<div class="<?php echo $class; ?>">
    ...
    <div class="liens">
        <a href="#" title="modifier" id="edit-<?php echo $id; ?>" class="modif_groupe"><img src="../graphisme/pencil.png" alt="modifier"/></a>
    </div>
...
<div class="<?php echo $class; ?> edit" id="form-edit-<?php echo $id; ?>">
	<form action="" method="post" id="modif_groupe_form_<?php echo $id; ?>">
        ...
        <p class="legend">Informations :</p>
            ...
            <p><label for="groupe_libelle-<?php echo $id; ?>">libellé : </label><input type="text" id="groupe_libelle-<?php echo $id; ?>" name="libelle" value="<?php echo $nom; ?>" /></p>
        </fieldset>
