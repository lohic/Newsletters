...
<div id="content" style="margin:auto;width:800px;">
  <table width="800" border="0" cellspacing="0" cellpadding="0" background="#FFF">
    ...
    <td colspan="7" align="right" bgcolor="#CCCCCC"><span style="color:#333333"><a name="haut" id="haut2"></a>Si vous ne visualisez pas correctement la Newsletter, <a href="http://news.sciences-po.fr/archive-<?php echo $news->unique_id();?>.html" style="color:#FF0000">cliquez ici</a></span></td>
    <td width="15" bgcolor="#CCCCCC">&nbsp;</td>
  </tr>
    <!--<tr>
