...
<div style="width:155px" class="bloc">
    ...
    <p style="" class="texte"><a href="http://capricorne.sciences-po.fr/evenements/?eventId=<?php echo $id_event;?>&fromnews=<?php echo $news_id; ?>" target="_blank"><img src="<?php echo $template?>images/inscription.gif" /></a> <a style="float:right;font-size:10px;" href="<?php echo $item['URL']; ?>">+ d'infos</a></p>
    
    <?php }else if($origine == "evenement_new_db"){ ?>
    
    <p style="" class="texte"><a href="http://www.sciencespo.fr/evenements/inscription/inscription_multiple.php?id=<?php echo $id_event;?>&fromnews=<?php echo $news_id; ?>" target="_blank"><img src="<?php echo $template?>images/inscription.gif" /></a> <a style="float:right;font-size:10px;" href="<?php echo $item['URL']; ?>">+ d'infos</a></p>
