...
?>
``` | 
adresse des images du dossier template | ```php <?php echo $template;?>images/``` | 
insérer une liste d'actualités/événements/item RSS | ```php <?php $news->set_contenu("nom_de_la_liste","fichier_bloc.php"); ?> ``` |
