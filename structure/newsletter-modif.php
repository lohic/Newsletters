...
<div class="options">
	<a href="../show/?id=<?php echo $id_newsletter ?>" target="_blank">
...
<div class="admin menu">
    <div class="container">
        ...
        <form id="refresh_event_list_form" action="XMLrequest_refresh_list.php" method="post">
        	<a href="#" id="rss_btn" class="btn" title="Rafraichir les flux RSS"><img src="../graphisme/rss.png" alt="modifier"/></a>
            <input type="hidden" id="id_newsletter" name="id_newsletter" value="<?php echo $id_newsletter; ?>" />
            <p><?php $news->get_source_news($core->groups_id); ?></p>
            <?php echo createSelect($news->get_source_news($core->groups_id),	'origine', 	'aucun', 	"onchange=\"$('#refresh_event_list_form').submit();\"", false ); ?>
...
<!-- LE TEMPLATE De NEWSLETTER -->
    ...
    <div id="RightPane" class="admin">
        <div class="container">
            ...
            <?php echo $news->get_liste_evenements_new(date('Y'),date('m'));?>
            </ul>
        </div>
    </div>
</div>
...
<?php }else{ ?>
<div class="reset"></div>
<div id="return_refresh">état : CETTE NEWSLETTER EST ARCHIVÉE, VOUS NE POUVEZ PAS LA MODIFIER !</div>
