...
<div class="form_container">
    ...
    <form id="add_dest_form" action="" method="post" >
        <fieldset>
            ...
            <p><label for="dest_nom">libellé : </label><input type="text" name="nom" id="dest_nom" class="inputField" /></p>
            <p><label for="dest_mail">mail : </label><input type="text" name="mail" id="dest_mail" class="inputField" /></p>
    ...
    <div id="dest-list">
	<?php echo $dest->get_dest_list($core->groups_id); ?>
    </div>
