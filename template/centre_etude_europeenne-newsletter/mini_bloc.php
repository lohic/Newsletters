...
<p style="text-align:justify;font-size:10px" class="texte"><?php echo !empty($soustitre)?$soutitre:$texte;?></p>
    ...
    <p style="" class="texte">
		<?php if($isInscription == '1'){?>
			...
			<?php } ?> 
      <a style="float:right;font-size:10px;color:#006766;" href="<?php echo $URL; ?>"><?php echo !empty($item['moreTXT']) ? $item['moreTXT'] : '+ d\'infos'; ?></a></p>
    
    <?php }else if(isset($URL) || $linkToActu){ ?>
       
    <p style="" class="texte"><span class="evenements" style="color:#006766;font-weight:bold;">&gt;&gt;</span> <a href="<?php echo $linkToActu?$itemURL:$URL;?>" target="_blank"><?php echo !empty($item['moreTXT']) ? $item['moreTXT'] : '+ d\'infos'; ?></a></p>
