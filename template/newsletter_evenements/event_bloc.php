...
<p style="margin:0 0 0 255px;" class="texte"><?php echo !empty($soustitre)?$soustitre:$texte;?></p>
<?php if($origine == "evenement_db" || $origine == "evenement_new_db"){ ?>
<p style="margin:0 0 0 255px" class="texte">&gt; <a href="<?php echo $itemURL;?>&fromnews=<?php echo $news_id; ?>" target="_blank">voir la fiche &eacute;v&eacute;nement</a></p>
<?php }else if(isset($URL) || $linkToActu){ ?>
<p style="margin:0 0 0 255px" class="texte">&gt; <a href="<?php echo $linkToActu?$itemURL:$URL;?>" target="_blank"><?php echo !empty($moreTXT)?$moreTXT:'En savoir plus';?></a></p>
<?php } ?>
</div>
