...
<div id="content" style="margin:auto;width:800px;">
  <table width="800" border="0" cellspacing="0" cellpadding="0" background="#FFF">
    ...
    <td colspan="3" align="right" bgcolor="#CCCCCC"><span style="color:#333333;font-size:11px"><a name="haut" id="haut2"></a>Si vous ne visualisez pas correctement ce message, <a href="http://www.sciencespo.fr/newsletter/archive-<?php echo $news->unique_id();?>.html" style="color:#FF0000">cliquez ici</a></span></td>
    <td width="15" bgcolor="#CCCCCC">&nbsp;</td>
  </tr>
    <!--<tr>
