...
<div style="clear:both; margin-bottom:20px;width:540px;" class="bloc">
    ...
    <p style="text-align:justify;" class="texte"><?php echo !empty($soustitre)?$soutitre:$texte;?></p>
    
    <div style="width:540px;height:1px;clear:both;"></div>
    
    <?php if($origine == "evenement_db" || $origine == "evenement_new_db"){ ?>
    
    <p style="float:right;font-size:10px;" class="texte"><span class="une" style="color:#cc0099;font-weight:bold;">&gt;&gt;</span> <a href="<?php echo $itemURL;?>&fromnews=<?php echo $news_id; ?>" target="_blank">+ d'infos</a></p>
    ...
    <p style="float:right;font-size:10px;;" class="texte"><span class="vie" style="color:#cc0099;font-weight:bold;">&gt;&gt;</span> <a href="<?php echo $linkToActu?$itemURL : $URL;?>" target="_blank"><?php echo !empty($moreTXT)?$moreTXT:'En savoir plus';?></a></p>
