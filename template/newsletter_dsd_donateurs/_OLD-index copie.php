...
<div id="content" style="margin:auto;width:800px;">
  <table width="800" border="0" cellspacing="0" cellpadding="0" background="#FFF">
    ...
    <td colspan="7" align="right" bgcolor="#CCCCCC"><span style="color:#333333;font-size:10px;"><a name="haut" id="haut2"></a>Si vous ne visualisez pas correctement la Newsletter, <a href="http://www.sciencespo.fr/newsletter/archive-<?php echo $news->unique_id();?>.html" style="color:#030">cliquez ici</a></span></td>
    <td width="15" bgcolor="#CCCCCC">&nbsp;</td>
  </tr>
    <!--<tr>
    ...
    <tr>
    <td colspan="9" bgcolor="#FFFFFF" background="<?php $header = $news->get_header("header.gif"); echo $header->image;?>" height="<?php echo $header->h;?>" ><p style="margin:35px 0 0 27px;color:#FFF;font-size:10px;"><?php 
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF">&nbsp;</td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
    <td height="50" colspan="4" rowspan="2" valign="bottom" bgcolor="#FFFFFF"><img src="<?php echo $template;?>images/rub_chiffre.gif" width="200" height="50" alt="Le chiffre" /></td>
  </tr>
  <tr>
    <td bgcolor="#CCCCCC">&nbsp;</td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
  ...
  <tr>
    <td height="50" colspan="4" bgcolor="#FFFFFF"><img src="<?php echo $template;?>images/rub_edito.gif" width="570" height="50" alt="Édito" /></td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
    <td bgcolor="#CCCCCC">&nbsp;</td>
  ...
  <tr>
    <td height="50" colspan="4" bgcolor="#FFFFFF"><img src="<?php echo $template;?>images/rub_campagne.gif" width="570" height="50" alt="La campagne" /></td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
    <td bgcolor="#CCCCCC">&nbsp;</td>
  ...
  <tr>
    <td height="50" colspan="4" bgcolor="#FFFFFF"><img src="<?php echo $template;?>images/rub_developpement.gif" width="570" height="50" alt="La vie académique et vous" /></td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
  ...
  <tr>
    <td colspan="9" bgcolor="#FFFFFF" background="<?php echo $template;?>images/foot.gif" height="95"  >
        ...
        <strong>La newsletter </strong>est une publication de la Direction de Stratégie et du Développement<br />
        <strong>Contact rédaction :</strong> <a href="mailto:donateurs@sciences-po.fr">donateurs@sciences-po.fr</a><br />
        <strong>Rédacteur en chef :</strong> Verane Fradin-Castelnau,<a href="mailto:verane.fradincastelnau@sciences-po.fr"> verane.fradincastelnau@sciences-po.fr </a><br />
        <strong>Directeur de la publication :</strong> Albin Gaudaire, Directeur du pôle donateurs
        </div>
      </td>
  </tr>
  <tr>
