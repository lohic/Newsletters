...
<div style="width:155px;clear:both;" class="bloc">
    ...
    <p style="margin:0;" class="texte"><a href="<?php echo $itemURL;?>&fromnews=<?php echo $news_id; ?>" target="_blank"><img style="border:0;" src="<?php echo $template?>images/inscription.gif" /></a> <a style="float:right;font-size:10px;margin-bottom:5px;" href="<?php echo $item['URL']; ?>">+ d'infos</a></p>
    ...
    <p style="margin:0;" class="texte">
		<?php if($isInscription == '1'){?>
			...
			<?php } ?> 
            <a style="float:right;font-size:10px;margin-bottom:5px;" href="<?php echo $itemURL; ?>">+ d'infos</a></p>
    
    <?php }else if(isset($URL)||$linkToActu){ ?>
    
    <p style="margin:0;" class="texte"><span class="evenements" style="color:#66cc00;font-weight:bold;">&gt;&gt;</span> <a href="<?php echo $linkToActu?$itemURL:$URL;?>" target="_blank">+ d'info</a></p>
