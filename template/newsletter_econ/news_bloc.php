...
<div style="clear:both; margin-bottom:20px;width:540px;" class="bloc">
    ...
    <p style="float:right;font-size:10px;" class="texte"><span class="une" style="color:#66ccff;font-weight:bold;">&gt;&gt;</span> <a href="<?php echo $itemURL;?>&fromnews=<?php echo $news_id; ?>" target="_blank">+ read more</a></p>
    ...
    <p style="float:right;font-size:10px;" class="texte"><span class="une" style="color:#FF0000;font-weight:bold;">&gt;&gt;</span> <a href="<?php echo $linkToActu?$itemURL:$URL;?>" target="_blank"><?php echo !empty($moreTXT)?$moreTXT:'read more';?></a></p>
