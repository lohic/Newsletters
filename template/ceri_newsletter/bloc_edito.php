...
<table width="565" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td valign="middle" bgcolor="#FFFFFF"><span style="color:#48494a;font-size:18px;font-weight:bold;"><a name="item-<?php echo $id;?>" id="item-<?php echo $id;?>"></a><?php echo $titre?></span></td>
    <td width="10" bgcolor="#FFFFFF">&nbsp;</td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <div style="color:#48494a;font-size:12px;margin:0;font-weight:bold;"><?php echo !empty($soustitre)?$soustitre:$texte;?></div>
