...
<table border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="30">&nbsp;</td>
    <td><div id="text" style="font-family:Arial, Helvetica, sans-serif;font-size:12px;color:#666;margin:15px 0;">
    ...
    <div style="font-size:10px;color:#660099!important;"><?php echo $info?></div>
    </div></td>
    <td width="30">&nbsp;</td>
  </tr>
</table>
