...
<div id="content" style="margin-top:0;margin-bottom:0;margin-left:auto;margin-right:auto;width:800px;">
  <table width="800" border="0" cellspacing="0" cellpadding="0" background="#FFF">
    ...
    <tr>
      ...
      <td width="540" valign="top" bgcolor="#FFFFFF"><h2 style="color:#ff3300;font-size:14px;font-weight:bold;">Actualités</h2>
        <?php
	...
	$news->set_sommaire("actualite_list",false,$style,8);

	?>
        <h2 style="color:#ffcc66;font-size:14px;font-weight:bold;margin-top:10px;">Ça vient de sortir</h2>
        <?php
    $style['li'] = "font-size:14px;font-weight:normal;";
	$style['date'] = "";
	$style['ul'] = "color:#ffcc66;margin:0;";
	
	$news->set_sommaire("vient_de_sortir_list",false,$style,8);
	?></td>
      <td width ="215" colspan="3" valign="top" bgcolor="#FFFFFF"><h2 style="color:#c1a37f;font-size:14px;font-weight:bold;">Agenda</h2>
        <?php
    $style['li'] = "font-size:14px;font-weight:normal;";
	$style['date'] = "";
	$style['ul'] = "color:#c1a37f;margin:0;";
	
	
	$news->set_sommaire("agenda_list",false,$style,8);
	?></td>
      <td width="15" bgcolor="#CCCCCC">&nbsp;</td>
    </tr>
    <tr>
  ...
  <tr>
    <td colspan="4" valign="top" bgcolor="#FFFFFF" background="<?php echo $template;?>images/back-left.gif"><table width="600" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="570" colspan="3" valign="top"><img src="<?php echo $template;?>images/rub_actualite.gif" width="570" height="50" alt="Actualités" border="0" /></td>
	...
	$news->set_contenu("actualite_list","post_bloc.php");
	
	$news->set_contenu("actualite_suite_list","post_bloc.php",0,"ET AUSSI...");
	...
	?></td>
      ...
      <tr>
        <td colspan="3" valign="top"><img src="<?php echo $template;?>images/rub_sortir.gif" width="570" height="50" alt="Ça vient de sortir" border="0" /></td>
        <td width="30" valign="top">&nbsp;</td>
      </tr>
      <tr>
        <td width="15" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
	...
	$news->set_contenu("vient_de_sortir_list","post_bloc.php");
	
	$news->set_contenu("vient_de_sortir_suite_list","post_bloc.php",0,"ET AUSSI...");
	...
	?></td>
      ...
      <tr>
        <td colspan="3" valign="top"><img src="<?php echo $template;?>images/rub_agenda.gif" width="570" height="50" alt="Agenda" border="0" /></td>
        <td width="30" valign="top">&nbsp;</td>
      </tr>
      <tr>
        <td width="15" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
	...
	$news->set_contenu("agenda_list","post_bloc.php");
	
	$news->set_contenu("agenda_suite_list","post_bloc.php",0,"ET AUSSI...");
    ...
    <td colspan="3" valign="top" bgcolor="#FFFFFF"  background="<?php echo $template;?>images/back-right.gif"><table width="200" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="4" valign="top"><img src="<?php echo $template;?>images/rub_chiffre.gif" width="200" height="50" alt="Le chiffre" border="0" /></td>
        </tr>
      <tr>
        <td valign="top">&nbsp;</td>
        <td valign="top"><?php
	...
	?></td>
      ...
      <tr>
        <td colspan="4" valign="top"><img src="<?php echo $template;?>images/rub_campus.gif" width="200" height="50" alt="Vie des campus" border="0" /></td>
        </tr>
      <tr>
        <td valign="top">&nbsp;</td>
        <td valign="top"><?php
	
	$news->set_contenu("vie_campus_list","mini_bloc.php");
	
	$news->set_contenu("vie_campus_suite_list","mini_bloc.php",0,"ET AUSSI...");
