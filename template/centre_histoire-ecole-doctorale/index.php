...
<div id="content" style="margin:auto;width:800px;">
  <table width="800" border="0" cellspacing="0" cellpadding="0" background="#FFF">
    ...
    <tr>
    <td colspan="5" bgcolor="#FFFFFF" background="<?php $header = $news->get_header("header-centre-histoire-doctoral.jpg"); echo $header->image;?>" height="<?php echo $header->h;?>" ><p style="margin:45px 0 0 27px;color:#FFF;font-size:10px;"><?php 
