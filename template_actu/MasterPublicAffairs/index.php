<div id="actu">
    <div id="header" style="background-image:url(<?php echo $templateFolder ?>/img/header.gif)" title="Sciences Po Master of public affairs, News for amumniand friends"></div>
    ...
    <?php if(isset($info['id'])){ ?>
        ...
        <p class="date"><?php echo utf8_encode(strftime('%e %B %Y',$timestamp)); ?></p>
