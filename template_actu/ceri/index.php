<div id="actu"  style="background-image:url(<?php echo $templateFolder ?>/img/fond.jpg)">
    <div id="header">
    
    <img src="<?php echo $templateFolder ?>/img/logo-ceri.gif" width="272" height="60" id="logo" alt="Sciences Po | CERI - CNRS" />
     <?php
