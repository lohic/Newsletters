    ...
    <h1>DSD Donateurs</h1><a href="http://www.sciencespo.fr/2013/content/14/comment-donner"><img src="<?php echo $templateFolder ?>/img/header-don.gif" id="don" border="0" /></a>
    <p class="date"><?php echo utf8_encode(strftime('%B %Y',$timestamp)); ?></p>
    </div>
    
    <div id="content">
        <?PHP if(isset($info['image'])){?><img src='<?php echo '../actu_images/'.$info['id'].'/'.$info['image']; ?>' width="740"/><?php } ?>
