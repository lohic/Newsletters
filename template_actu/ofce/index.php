<div id="actu">
    <div id="header" style="background-image:url(<?php echo $templateFolder ?>/img/header.jpg)"></div>
    ...
    <?php if(isset($info['id'])){ ?>
        ...
        <p class="date"><?php echo utf8_encode(strftime('%A %e %B %Y',$timestamp)); ?></p>
        <h1><?php echo $info['titre']; ?><div class="coin" style="background-image:url(<?php echo $templateFolder ?>/img/coin-titre.png)"></div></h1>
    ...
    <div id="footer" style="background-image:url(<?php echo $templateFolder ?>/img/foot.gif)"></div>
</div>